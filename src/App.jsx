        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div key={i} className="p-8 md:p-10 border border-slate-100 rounded-2xl bg-white hover:shadow-2xl transition-all group shadow-sm">
          ...
          <div className="grid md:grid-cols-12 gap-12 md:gap-24 items-start">
            <div className="md:col-span-5 relative">
              <div className="aspect-[4/5] overflow-hidden rounded-3xl border border-white/10 shadow-2xl">
                <ImageWithFallback src={CONFIG.images.bio} alt="Valúcia Furtado" className="w-full h-full object-cover" />
              </div>
